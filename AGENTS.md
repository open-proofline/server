...
- The current backend does not yet implement first-class incident modes, capture profiles, escalation policies, sharing state, trusted-contact accounts, dead-man switch notifications, public account workflows, or public `/v1` product authentication.
